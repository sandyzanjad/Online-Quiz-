<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Adminlogin.aspx.cs" Inherits="Quiz_Examination.Adminlogin" %>
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#EA4335', endColorstr='#4285F4',GradientType=1 );
    ...
    <div class="login">
        ...
        <tr>
           <td class="style2"><a href="Adminprofile.aspx">
